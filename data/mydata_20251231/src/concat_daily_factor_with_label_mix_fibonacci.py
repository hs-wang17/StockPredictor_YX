...
save_dir = "/home/haris/raid0/shared/haris/mydata_20251231/concat_daily_factor_with_label_mix_fibonacci"
os.makedirs(save_dir, exist_ok=True)
label_df = pd.read_feather("/home/haris/raid0/shared/haris/mydata_20251231/label_mix_fibonacci.fea")
factor_files = sorted(os.listdir(factor_dir))[:-22]
