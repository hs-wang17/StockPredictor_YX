...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default="/home/user0/mydata/concat_daily_factor", help="Directory containing stock data files")
    ...
    parser.add_argument(
        "--lgb_params", type=str, default=None, help='Optional JSON string for LightGBM params, e.g. \'{"num_leaves":63,"learning_rate":0.01}\''
    )
