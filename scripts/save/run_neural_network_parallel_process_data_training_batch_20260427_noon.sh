...
: "${BEGIN_PERIOD:=0}"
: "${CRITERION:=mse}"
: "${DATA_DIR:=/home/haris/raid0/shared/haris/mydata_20260127/concat_daily_factor_with_label_8}"
: "${DEVICE:=cuda:0}"
: "${END_DATE:=20301231}"
: "${EPOCHS:=40}"
...
: "${START_DATE:=20190101}"
: "${TRADE_DATE_PATH:=/home/haris/raid0/shared/haris/mydata_20260127/trade_date_8.fea}"
: "${TRAIN_BATCH_SIZE:=1}"
