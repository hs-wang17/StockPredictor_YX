...
printf "%s", $1
    ...
    printf "\n"
}' /home/haris/mymodel_noon_10/predictions/StockPredictor_20260308_merged_all_stocks.csv > /tmp/StockPredictor_20260308.csv

cat /home/haris/logs/update_predict_20260308.log | mutt -s "每日预测任务日志(noon_10) - $(date +\%Y-\%m-\%d)" -a /tmp/StockPredictor_20260308.csv -- xsheng9867@163.com

rm /tmp/StockPredictor_20260308.csv
